<div class="collapse navbar-collapse"></div>
    <header class="p-2 mb-2">
        <div class="container-lg">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdown04">
                        <li><a class="dropdown-item" href="mailto:gelastore@gmail.com">Escribenos un correo</a></li>
            ...
            <div class="text-end">
                <a href="./auth/login.php" type="button" class="btn btn-primary">Login</a>
                <a href="./auth/register.php" type="button" class="btn btn-primary">Sign-up</a>
            </div>
            </div>
        </div>
    </header>